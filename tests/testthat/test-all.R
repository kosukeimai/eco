...
test_that("tests eco on registration data", {
  ...
  expect_equal(x$param.table[2,1], 2.976173, tolerance = accuracy)
  expect_equal(x$param.table[3,4], 8.238363, tolerance = accuracy)
  ...
  expect_equal(x$W.table[1,1], 0.4896912, tolerance = accuracy)
  expect_equal(x$W.table[2,3], 0.3071461, tolerance = accuracy)
})  
...
test_that("tests eco on Robinson census", {
  ...
  expect_that(length(x), is_equivalent_to(8))
  expect_true("W2.table" %in% names(x))
  expect_equal(x$param.table[2,3], 2.068228, tolerance = accuracy)
  expect_equal(x$agg.wtable[1,3], 0.6631372, tolerance = accuracy)
  ...
  expect_that(length(x), is_equivalent_to(2))
  expect_true("n.draws" %in% names(x))
  expect_equal(x$W.table[1,3], 0.4499757, tolerance = accuracy)
  expect_equal(x$W.table[3,1], 0.3400277, tolerance = accuracy)
})
...
test_that("tests ecoBD on registration data", {
  ...
  expect_equal(x$aggWmin[1,1], 0.216785, tolerance = accuracy)
...
test_that("tests ecoML on census data", {
  ...
  expect_equal(x$loglik, -70.80674, tolerance = accuracy)
  expect_equal(x$param.table[2,3], 0.07192878, tolerance = accuracy)
  ...
  expect_that(length(x), is_equivalent_to(13))
  expect_true("iters.sem" %in% names(x))
  expect_equal(x$loglik, -3481.877, tolerance = accuracy)
  expect_equal(x$param.table[2,3], 0.006055498, tolerance = accuracy)
...
test_that("tests ecoNP on census data", {
  ...
  expect_equal(x$agg.table[1,2], 0.04059766, tolerance = accuracy)
  expect_equal(x$agg.table[2,3], 0.8129786, tolerance = accuracy)
  ...
  expect_that(length(x), is_equivalent_to(2))
  expect_true("n.draws" %in% names(x))
  expect_equal(x$W.table[1,3], 0.02617743, tolerance = accuracy)
  expect_equal(x$W.table[2,1], 0.8137116, tolerance = accuracy)
...
test_that("tests ecoNP on Robinson census data", {
  ...
  expect_equal(x$agg.table[1,2], 0.009952511, tolerance = accuracy)
  expect_equal(x$agg.table[2,3], 0.8690776, tolerance = accuracy)
  expect_equal(x$agg.wtable[1,2], 0.009508983, tolerance = accuracy)
  expect_equal(x$agg.wtable[2,3], 0.9005222, tolerance = accuracy)
  ...
  expect_that(length(x), is_equivalent_to(2))
  expect_true("n.draws" %in% names(x))
  expect_equal(x$W.table[1,3], 0.1333375, tolerance = accuracy)
  expect_equal(x$W.table[2,1], 0.8434944, tolerance = accuracy)
})
