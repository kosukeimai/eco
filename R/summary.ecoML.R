...
#' 
#' 
#' @aliases summary.ecoML print.summary.ecoML
...
#' upon calling \code{ecoML}.} \item{fix.rho}{Whether the correlation parameter
#' was fixed or allowed to vary, as specified by the user upon calling
#' \code{ecoML}.} \item{epsilon}{The convergence threshold specified by the
#' user upon calling \code{ecoML}.} \item{n.obs}{The number of units.}
...
#' \item{loglik}{The final observed log-likelihood.} \item{rho}{A matrix of
#' \code{iters.em} rows specifying the correlation parameters at each iteration
...
#' parameters in \code{param.table}.} \item{param.table}{Final estimates of the
#' parameter values for the model.  Excludes parameters fixed by the user upon
#' calling \code{ecoML}.  See \code{ecoML} documentation for order of
#' parameters.} \item{agg.table}{Aggregate estimates of the marginal means of
#' \eqn{W_1} and \eqn{W_2}} \item{agg.wtable}{Aggregate estimates of the
#' marginal means of \eqn{W_1} and \eqn{W_2} using \eqn{X} and \eqn{N} as
#' weights.} If \code{units = TRUE}, the following elements are also included:
